...
def test_llm_batch_namespace_injection() -> None:
    ...
    assert report.answer is not None and "True" in report.answer, f"llm_batch should exist in namespace. Answer: {report.answer}"
...
def test_llm_batch_empty_list_handling() -> None:
    ...
    assert report.answer is not None and "[]" in report.answer, f"Should return empty list. Answer: {report.answer}"
